        ...
        <div class="box-view container">
            ...
            <div class="container text-center">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php
                            include('Connect.php');
                            $query = "SELECT DISTINCT lecturer.lecturer_name, lecturer.staff_id 
                                    FROM committee_lecturer 
                                    INNER JOIN lecturer ON committee_lecturer.staff_id = lecturer.staff_id 
            ...
            <div class="container container-right">
                <div class="gap-2 d-md-block mt-2 mb-2">
                    <a href="Query02.php" class="btn btn-danger">Prev Query</a>
                    <a href="Query04.php" class="btn btn-primary">Next Query</a>
                </div>
            </div>
        </div>
    </div>
